...
<div class="<?php esc_attr_e(WOO_CUSTOM_GATEWAY_SLUG); ?> notice notice-info is-dismissible">
    <div>
        <div class="<?php esc_attr_e(WOO_CUSTOM_GATEWAY_SLUG); ?>-prompt">
            <?php printf(__('Please consider enabling usage collection for %s. This helps us improve our product and provide better features to you in the future.', WOO_CUSTOM_GATEWAY_SLUG), __('Woo Custom Gateway', WOO_CUSTOM_GATEWAY_SLUG)); ?>
        </div>
        <div class="<?php esc_attr_e(WOO_CUSTOM_GATEWAY_SLUG); ?>-button">
            <a class="button btn-yield" href="#"
               ...
               data-action="<?php esc_attr_e('analytics-enable'); ?>">
                <?php _e('Enable ', WOO_CUSTOM_GATEWAY_SLUG); ?>
            </a>
